...
const NitteTrail = () => {
  ...
  return (
    <div className='h-screen bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r' style={{paddingTop:search?"10rem":"16rem"}}>
       {search?"":<h1 className='text-7xl font-bold text-center text-white flex justify-center items-center'>NitteTrail</h1>}
    ...
    <div className="relative">
        ...
        <button type="submit" className=" text-black absolute right-2.5 bottom-2.5 bg-nitteYellow hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-semibold rounded-lg text-sm px-4 py-2 dark:bg-nitteYellow dark:hover:bg-yellow-300 dark:focus:ring-red-800">Search</button>
    </div>
</form>
<div>
