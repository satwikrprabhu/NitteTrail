...
const NitteTrail = () => {
  ...
  return (
    ...
    <div className="relative">
        ...
        <button type="submit" className=" text-black absolute right-2.5 bottom-2.5 bg-nitteYellow hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-semibold rounded-lg text-sm px-4 py-2 dark:bg-nitteYellow dark:hover:bg-yellow-300 dark:focus:ring-red-800 nittetext1">Search</button>
    </div>
</form>
<div>
