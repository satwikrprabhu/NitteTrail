            ...
            <div className="flex flex-col md:flex-row md:flex-wrap  text-white justify-around pt-8 px-6 md:p-12">
                {coursetitle.map((course, index) => (
                    ...
                    >
                        ...
                        >
                            <h3 className="text-2xl font-bold text-white text-left">{course.title}</h3>
                            <Link to={course.url} className="text-black bg-white border-none  px-3 py-1 font-semibold rounded-md
